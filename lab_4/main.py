...
def main(
    ...
    dataset_column: str = "messages_no_thinking", 
    dataset_num_rows: int = None, 
    eval_num_rows: int = None, 

    # --- TRAINING PARAMETERS ---
    output_dir: str = "outputs",
    hub_model_id: str = "Qwen3-0.6B-QLoRA-Finetuning",
    ...
    log.info(f"You can load it normally with: AutoModelForCausalLM.from_pretrained('{hub_model_id}')")
